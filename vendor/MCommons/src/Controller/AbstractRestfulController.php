...
class AbstractRestfulController extends RestfulController {
    ...
    public function sendError($message = '', $code = 500) {
        ...
        return \MCommons\StaticFunctions::getErrorResponse($this->getServiceLocator(), $message, $code);
    }
...
//        $formattedResponse = [];
//        $formattedResponse['result'] = (bool) count($data);
//        $formattedResponse['data'] = $data;
//        return new \Zend\View\Model\JsonModel($formattedResponse);
